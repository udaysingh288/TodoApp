...
SECRET_KEY = '8cb9d3428f23593cd9c9a3be7a33f50a441758e80fb35d24abcf7e3f9ffea738'
ALGORITHM = 'HS256'
...
def create_access_token(username:str,userid:str,role:str,expires_delta:timedelta):
